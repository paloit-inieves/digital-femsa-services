...
- (nonnull id)initWithChallengeUrl:(nonnull NSURL*)challengeUrl sendBiometrics:(BOOL)sendBiometrics_;
...
- (nonnull id)initWithChallengeUrl:(nonnull NSURL*)challengeUrl debugKey:(nonnull NSString*) debugKey sendBiometrics:(BOOL)sendBiometrics_;
#endif
